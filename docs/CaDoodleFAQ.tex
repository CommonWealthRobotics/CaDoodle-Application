...
\begin{minipage}[t]{0.33\textwidth}
    ...
    \textbf{Q: Is it free?} A: For Linux CADoodle is free. To access a signed instaaller of CADoodle from the Apple App store or the Microsoft store is not free. There are also unsigned installers availible for all platforms for free. \\[0.1cm]
