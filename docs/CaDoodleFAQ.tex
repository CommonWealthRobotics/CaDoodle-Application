...
% Bird overlay: places bird-logo.png as an overlay at a tunable position
% Usage: \birdoverlay[width fraction][x offset][y offset][panel number][mirrored]
% width fraction: relative to \linewidth (default 0.15)
% x, y offsets: in cm, relative to panel center (default 0cm)
% panel number: 1, 2, or 3 (for left, middle, right panel)
% mirrored: 0 for normal, 1 for mirror left-right (default 0)
% Bird overlay: places bird-logo.png as an overlay at a tunable position
% Usage: \birdoverlay[width fraction]{x offset}{y offset}{panel}{mirror}
\newcommand{\birdoverlay}[5][0.15]{%
	\begin{tikzpicture}[remember picture,overlay]
		\ifnum#5=0
		\def\mirrorfactor{1}
		\else
		...
		inner sep=0pt,
		xscale=\mirrorfactor
		] at ($(current page.center)+(\paneloffset,0)+(#2,#3)$)
		{
			\includegraphics[width=#1\linewidth]{bird-logo.png}
		};
	\end{tikzpicture}%
}
	...
	\begin{minipage}[c][\textheight][c]{\textwidth}
		\begin{center}
			\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{3.5in}p{3.5in}p{3.5in}}
				...
				\panelstart
				\birdoverlay[0.2]{0cm}{-5.8cm}{1}{1}
				{\color{posterblue}\huge\textbf{Key Features}}\\[0.2cm]
				...
				\panelstart
				\birdoverlay[0.2]{-2.5cm}{-4.5cm}{2}{0}
				{\color{posterblue}\huge\textbf{FAQs}}\\[0.2cm]
				\footnotesize
				...
				\includegraphics[width=0.9\linewidth]{OpenSaucePoster.pdf}
	...
	\begin{minipage}[c][\textheight][c]{\textwidth}
		\begin{center}
			\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}p{3.5in}p{3.5in}p{3.5in}}
				% PANEL 1: SCREENSHOTS
				\panelstart
				\birdoverlay[0.2]{3.5cm}{8.5cm}{1}{1}
				{\color{posterblue}\huge\textbf{Interface Preview}}\\[0.2cm]
				...
				% PANEL 2: BACK COVER
				\panelstart
				\birdoverlay[0.2]{-3.5cm}{-9.5cm}{2}{0}
				\raggedright
				\color{posterblue}\huge\textbf{History}\\[0.2cm]
				\footnotesize
				...
				\panelstart
				\birdoverlay[0.2]{-2.5cm}{-2.5cm}{3}{0}
				{\color{posterblue}\huge\textbf{Educational Use}}\\[0.2cm]
				...
				\small \url{support@cadoodlecad.com}
				\\[0.1cm]
				\begin{center}
