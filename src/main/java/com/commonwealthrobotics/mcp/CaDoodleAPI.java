...
public class CaDoodleAPI {
    ...
    public Map<String, Object> addOperation(String operationType, Map<String, Object> params) {
        ...
        try {
            Class<? extends com.neuronrobotics.bowlerstudio.scripting.cadoodle.CaDoodleOperation> opClass = OPERATION_TYPES.get(operationType);
            if (opClass == null) {
            ...
            com.neuronrobotics.bowlerstudio.scripting.cadoodle.CaDoodleOperation op = opClass.getDeclaredConstructor().newInstance();
    ...
    private void configureOperation(com.neuronrobotics.bowlerstudio.scripting.cadoodle.CaDoodleOperation op, String type, Map<String, Object> params) {
        ...
        if (params.containsKey("workplane")) {
            ...
            try {
                ...
                if (wpMap.containsKey("translateX")) wp.setX(wpMap.get("translateX"));
                if (wpMap.containsKey("translateY")) wp.setY(wpMap.get("translateY"));
                if (wpMap.containsKey("translateZ")) wp.setZ(wpMap.get("translateZ"));
                ...
                try {
                    java.lang.reflect.Method setWorkplane = op.getClass().getMethod("setWorkplane", com.neuronrobotics.sdk.addons.kinematics.math.TransformNR.class);
            ...
            case "Align":
                if (op instanceof Align) {
                    ...
                    if (params.containsKey("x")) {
                        try {
                            com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment alignment = 
                                com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment.valueOf(params.get("x").toString());
                            align.x = alignment;
                        } catch (Exception e) {
                    ...
                    if (params.containsKey("y")) {
                        try {
                            com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment alignment = 
                                com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment.valueOf(params.get("y").toString());
                            align.y = alignment;
                        } catch (Exception e) {
                    ...
                    if (params.containsKey("z")) {
                        try {
                            com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment alignment = 
                                com.neuronrobotics.bowlerstudio.scripting.cadoodle.Alignment.valueOf(params.get("z").toString());
                            align.z = alignment;
                        } catch (Exception e) {
    ...
    public Map<String, Object> regenerate(String sourceOperationId) {
        ...
        try {
            ...
            List<com.neuronrobotics.bowlerstudio.scripting.cadoodle.CaDoodleOperation> operations = activeProject.get().getOperations();
